...
export default function Home() {
  return (
    <div className="min-h-screen bg-[#FAFBFC] text-[#1A2332]">
      {/* ── Navigation ── */}
      <nav className="fixed top-0 w-full bg-white/80 backdrop-blur-md border-b border-[#E8ECF1] z-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          ...
          <div className="hidden sm:flex items-center gap-6 text-sm text-[#5A6578]">
            <Link href="#how-it-works" className="hover:text-[#0D9488] transition-colors">
              How It Works
            </Link>
            <Link href="#features" className="hover:text-[#0D9488] transition-colors">
              Features
            </Link>
            <Link href="#safety" className="hover:text-[#0D9488] transition-colors">
              Safety
            </Link>
          </div>
          <Link
            href="/quiz"
            className="bg-[#0D9488] hover:bg-[#0F766E] text-white text-sm font-medium px-4 py-2 rounded-lg transition-colors"
          >
      ...
      <section className="pt-28 sm:pt-36 pb-16 sm:pb-24 px-4 sm:px-6">
        <div className="max-w-6xl mx-auto">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-[1.1] tracking-tight text-[#1A2332] mb-6">
              Your supplements,{" "}
            ...
            <p className="text-lg sm:text-xl text-[#5A6578] leading-relaxed mb-8 max-w-2xl">
              ...
              supplement protocol — with doses, timing, interactions checked,
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <Link
                href="/quiz"
                className="inline-flex items-center justify-center gap-2 bg-[#0D9488] hover:bg-[#0F766E] text-white font-medium px-6 py-3.5 rounded-xl text-base transition-colors"
              >
              ...
              <Link
                href="#how-it-works"
                className="inline-flex items-center justify-center gap-2 bg-white hover:bg-[#F1F5F9] border border-[#E2E8F0] text-[#1A2332] font-medium px-6 py-3.5 rounded-xl text-base transition-colors"
              >
                See How It Works
              </Link>
            </div>

            <div className="flex items-center gap-4 mt-8 text-sm text-[#5A6578]">
      ...
      {/* ── Trust Bar ── */}
      <section className="border-y border-[#E8ECF1] bg-white py-8 px-4 sm:px-6">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-center gap-6 sm:gap-12 text-sm text-[#5A6578]">
          <div className="flex items-center gap-2">
          ...
          <div className="flex items-center gap-2">
            ...
            Designed by a Medical Director
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div
                key={item.step}
                className="bg-white border border-[#E8ECF1] rounded-2xl p-6 hover:border-[#0D9488]/30 hover:shadow-sm transition-all"
              >
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <div
                key={feature.title}
                className="border border-[#E8ECF1] rounded-2xl p-6 hover:border-[#0D9488]/30 hover:shadow-sm transition-all bg-[#FAFBFC]"
              >
                <div className="w-10 h-10 rounded-xl bg-[#F0FDFA] flex items-center justify-center text-[#0D9488] mb-4">
                  {feature.icon}
                </div>
                <h3 className="text-lg font-semibold text-[#1A2332] mb-2">
                  {feature.title}
          ...
          <div className="bg-gradient-to-br from-[#F0FDFA] to-[#CCFBF1]/40 border border-[#99F6E4] rounded-3xl p-8 sm:p-12">
            <div className="max-w-3xl">
              ...
              <p className="text-[#5A6578] text-lg leading-relaxed mb-8">
                NutriGenius was designed by a Medical Director in pharmaceutical
                clinical development. Every recommendation passes through
      ...
      <section className="py-16 sm:py-24 px-4 sm:px-6 bg-white">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-[#5A6578] text-lg mb-8 max-w-2xl mx-auto">
            Join thousands of users who have replaced guesswork with
            evidence-based supplementation. It takes 5 minutes and it&apos;s
            completely free.
          </p>
          <Link
            href="/quiz"
            className="inline-flex items-center justify-center gap-2 bg-[#0D9488] hover:bg-[#0F766E] text-white font-medium px-8 py-4 rounded-xl text-lg transition-colors"
          >
      ...
      {/* ── Footer ── */}
      <footer className="border-t border-[#E8ECF1] bg-[#FAFBFC] py-12 px-4 sm:px-6">
        <div className="max-w-6xl mx-auto">
