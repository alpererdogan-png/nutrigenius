          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div>
              ...
              <div className="flex items-start gap-4 mb-8">
                <div className="relative w-20 h-20 rounded-full overflow-hidden ring-2 ring-teal-500/30 shadow-lg flex-shrink-0">
                  <Image
      ...
      <footer className="bg-white py-12 px-4 sm:px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-[#f9f9ff] rounded-xl p-4 mt-4 space-y-3">
            ...
            <p className="text-xs text-[#8896A8] leading-relaxed inline-flex items-center gap-2 flex-wrap">
