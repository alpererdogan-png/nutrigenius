...
export default async function Home() {
  ...
  // Server-rendered blog preview section — passed as a slot into HomeClient
  // so it appears in the initial HTML for SEO / Google crawlers.
  const blogSection = (
  ...
  return <HomeClient blogSection={blogSection} />;
}
